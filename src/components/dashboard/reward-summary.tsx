...
export function RewardSummary() {
  ...
  return (
    <div className="bg-[#201f1f] p-4 md:p-8 rounded-lg border border-[#484847]/10 relative overflow-hidden">
      {/* Decorative element */}
      <div className="absolute top-0 right-0 w-24 h-24 bg-primary/5 rounded-full -mr-12 -mt-12 blur-2xl" />
      
      <h4 className="font-bold text-xs tracking-[0.2em] mb-6 md:mb-8 text-muted-foreground border-b border-[#484847]/10 pb-4">
        REWARD SUMMARY
      </h4>
      ...
      <div className="space-y-6 md:space-y-10">
        ...
        {/* Campaign Meta */}
        <div className="pt-4 md:pt-6 border-t border-[#484847]/10">
...
export function TacticalNote() {
  return (
    <div className="bg-[#131313] p-4 md:p-6 rounded-lg border border-[#484847]/10">
      <div className="flex items-center gap-2 mb-3 md:mb-4">
        <Lightbulb className="w-4 h-4 text-primary flex-shrink-0" />
        <h4 className="font-bold text-sm">Tactical Note</h4>
      </div>
      <p className="text-xs text-muted-foreground leading-relaxed mb-3 md:mb-4">
